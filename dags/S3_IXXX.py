...
dag = DAG(
dag_id='S3_IXXX',
description='This Dag demonstrates S3 bucket capabilities with regular expressions supporting all capabilities from chronos',
...
def init(objects, **kwargs):
     iconfig = Variable.get("S3_IXXX_config", deserialize_json=True)
