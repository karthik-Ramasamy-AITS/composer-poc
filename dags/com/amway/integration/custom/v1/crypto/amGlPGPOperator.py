...
from com.amway.integration.custom.v1.AmGlCommonV1 import logInfo, logDebug, logError, handleFailures, generateRandom, update_extension
    ...
    def execute(self, context: Any) -> str:
        ...
        try:
            ...
            if len(list_of_files) > 0:
                ...
                logInfo(f'Operator: There are no files available in {self.local_path}')
                logInfo(f'Operator: Skipping the encryption/decryption process')
            ...
            logToPVF(os.environ.get('AIRFLOW_CTX_DAG_RUN_ID'), #key
                     ...
                     f'Operator: Failure in AmGlPGPOperator, reason {e}' #ActivityMessage
                     )	
            handleFailures()
