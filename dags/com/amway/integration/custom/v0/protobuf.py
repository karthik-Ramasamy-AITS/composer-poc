...
def topic_subject_name_strategy(ctx, record_name):
    ...
    if ctx.headers is None:
        ...
        print("topic_subject_name_strategy - "+ctx.headers)
        cdmName = ctx.headers
        print(f'cdmName is - {cdmName}')
        subjectName = cdmName.replace(".", "_" )
        subjectName = subjectName.replace(":", "_" )
        subjectName = subjectName+'-record'
...
def topic_record_subject_name_strategy(ctx, record_name):
    ...
    """
    #print("topic_record_subject_name_strategy - "+ctx.headers)
...
def record_subject_name_strategy(ctx, record_name):
    ...
    """
    #print("record_subject_name_strategy - "+ctx.headers)
    return record_name
...
def reference_subject_name_strategy(ctx, schema_ref):
    ...
    """
    #print("reference_subject_name_strategy - "+ctx.headers)
    return schema_ref.name

def amway_record_name_strategy(ctx, cdmName):
    """
    Constructs a subject reference name in the form of {reference name}.
